      ...
      <Layout title="ホーム" user={user} lists={[]} listQuota={listQuota}>
        <div class="empty-state" style="margin: 3rem auto; max-width: 500px;">
          ...
          {listQuota.canCreate ? (
            ...
            <div class="alert-info" style="margin-top: 1rem; padding: 0.85rem; background: rgba(217, 138, 86, 0.1); border: 1px solid var(--color-primary); border-radius: var(--radius-md); font-size: 0.875rem; color: var(--color-text); line-height: 1.5;">
